...
int main([[maybe_unused]]int argc, [[maybe_unused]]char* argv[])
{
    ...
    glimac::Program program = loadProgram(applicationPath.dirPath() + "shaders/3D.vs.glsl", applicationPath.dirPath() + "shaders/tex3D.fs.glsl");
    program.use();
    ...
    GLint mTexture = glGetUniformLocation(program.getGLId(), "mTexture");
